...
public class Joueur extends Personnage {
	...
	public void ChoixClasse(){
		...
		System.out.println("\nAragorn : Quel est votre classe de pr�dilection " + _name + " ?! \n");
		...
		switch(choix_classe)
		{
			case 1 :
			{
				...
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Classes[0] + "\n" 
			...
			case 2 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Classes[1] + "\n" 
						+ "Aragorn : " + classe.getDescription() + "\n" 
						+ "Aragorn : En es-tu certains ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
			...
			case 3 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Classes[2] + "\n" 
						+ "Aragorn : " + classe.getDescription() + "\n" 
						+ "Aragorn : En es-tu certains ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
			...
			case 4 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Classes[3] + "\n" 
						+ "Aragorn : " + classe.getDescription() + "\n" 
						+ "Aragorn : En es-tu certains ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
			...
			case 5 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Classes[4] + "\n" 
						+ "Aragorn : " + classe.getDescription() + "\n" 
						+ "Aragorn : En es-tu certains ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
			...
			case 6 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Classes[5] + "\n" 
						+ "Aragorn : " + classe.getDescription() + "\n" 
						+ "Aragorn : En es-tu certains ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
			...
			case 7 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Classes[6] + "\n" 
						+ "Aragorn : " + classe.getDescription() + "\n" 
						+ "Aragorn : En es-tu certains ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
	...
	public void ChoixRace()
	{
		Commande.NettoyerConsole();
		Commande.AfficherSeparateur(122);
		System.out.println("\nAragorn : Votre apparence ne m'est pas famili�re, quel est votre ethnie " + _name + " ?! \n");
		...
		switch(choix_race)
		{
			case 1 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Races[0] + "\n" 
			...
			case 2 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Races[1] + "\n" 
						+ "Aragorn : De ce que je connais, " + race.getDescription() + "\n" 
						+ "Aragorn : Est-ce bien cela ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
			...
			case 3 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Races[2] + "\n" 
						+ "Aragorn : De ce que je connais, " + race.getDescription() + "\n" 
						+ "Aragorn : Est-ce bien cela ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
			...
			case 4 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Races[3] + "\n" 
						+ "Aragorn : De ce que je connais, " + race.getDescription() + "\n" 
						+ "Aragorn : Est-ce bien cela ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
			...
			case 5 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Races[4] + "\n" 
						+ "Aragorn : De ce que je connais, " + race.getDescription() + "\n" 
						+ "Aragorn : Est-ce bien cela ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
			...
			case 6 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Races[5] + "\n" 
						+ "Aragorn : De ce que je connais, " + race.getDescription() + "\n" 
						+ "Aragorn : Est-ce bien cela ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
			...
			case 7 :
			{
				...
				Commande.NettoyerConsole();
				Commande.AfficherEntete(200,
						  "\nAragorn : Alors comme �a tu es un " +  Races[6] + "\n" 
						+ "Aragorn : De ce que je connais, " + race.getDescription() + "\n" 
						+ "Aragorn : Est-ce bien cela ?\n\n"
						+ "[1] Oui ! \n"
						+ "[2] Non ! \n");
	...
	public void Recapitulatif() {
		...
		Commande.AfficherEntete(122,
				...
				+ "     Comp�tences : " + classe.getAttaquesPhysiques().get(0).getNom() + " , " + classe.getAttaquesPhysiques().get(1).getNom() + " , " + classe.getAttaquesMagiques().get(0).getNom() + " , " + classe.getAttaquesMagiques().get(1).getNom() + "\n"
				+ "    \n"
