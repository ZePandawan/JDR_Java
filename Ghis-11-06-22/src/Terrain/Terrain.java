...
public enum Terrain implements TerrainIntf {
    ...
    public void combatTerrain(Joueur joueur) {
        ...
        if (SpawnRate<=65) {
        	System.out.println(
        			  "------------------------------------------------------------------------------------------------------------------------\n"
        			+ "Vous allez affronter : " + listeMonstres.get(0).getNom() + " \n\n"
        			+ "Descriprion : " + listeMonstres.get(0).getDescription() + "\n"
        			+ "------------------------------------------------------------------------------------------------------------------------\n");
        	...
        	System.out.println(
      			  "------------------------------------------------------------------------------------------------------------------------\n"
      			+ "Vous allez affronter : " + listeMonstres.get(1).getNom() + " \n\n"
      			+ "Descriprion : " + listeMonstres.get(1).getDescription() + "\n"
      			+ "\"------------------------------------------------------------------------------------------------------------------------\\n\"");
        	...
        	System.out.println(
      			  "------------------------------------------------------------------------------------------------------------------------\n"
      			+ "Vous allez affronter : " + listeMonstres.get(2).getNom() + " \n\n"
      			+ "Descriprion : " + listeMonstres.get(2).getDescription() + "\n"
      			+ "\"------------------------------------------------------------------------------------------------------------------------\\n\"");
