...
public class Joueur extends Personnage implements JoueurIntf {
	...
	public void recapitulatif() {
		...
		System.out.print("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   \n"
						...
						+ "    \n"
						+ "    Arme : " + classe.getArme().getNom() + " \n"
						+ "    Armure : " + classe.getArmure() + "\n\n"
						+ "    Inventaire : \n");
		System.out.print( "   | ");
					for(Consommables objet : getInventaire()._Inventory)
					{
