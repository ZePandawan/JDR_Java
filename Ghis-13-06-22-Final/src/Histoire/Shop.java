...
public class Shop implements ShopIntf{
	...
	public void afficherShop(Joueur joueur)
	{
		...
		System.out.println("Bienvenue à toi aventurier ! Que veux-tu acheter ?\n\n"
				+ "Votre Or : " + joueur.getArgent() + "\n");
		...
		switch(choix) {
			...
			case 15:{
				System.out.println("Au revoir mon brave !");
				Commande.nettoyerConsole();
				break;
			}
			default:{
	...
	public void acheterItem(Consommables Item, Joueur joueur)
	{
		...
		if(argentJoueur - argentItem >= 0) {
			if(joueur.getInventaire().verif_inventaire_plein(joueur) == false)
			{
